      ...
      <ScrollReveal>
        <div className="space-y-6">
          ...
          <div>
            ...
            <a href={`mailto:${SITE.email}`} className="text-silver hover:text-amber transition-colors">
              {SITE.email}
            </a>
          </div>
          <div>
        ...
        <form onSubmit={onSubmit} className="rounded-3xl bg-carbon border border-white/[0.06] p-6 md:p-8 space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full bg-transparent border-b border-white/[0.1] py-2 text-silver focus:outline-none focus:border-amber"
              required
            />
          </div>
          <div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-transparent border border-white/[0.1] rounded-xl p-3 text-silver focus:outline-none focus:border-amber resize-none"
            />
          </div>

          <button
            type="submit"
            className="w-full py-3 rounded-full bg-amber text-ink font-medium hover:-translate-y-0.5 transition-transform"
          >
            Submit
          </button>
        </form>
