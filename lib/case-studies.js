export const CASE_STUDIES = [
  {
    ...
    card: {
      frame: 'cover-spread',
      images: [
        '/assets/baari/signal-analytics.png',
        '/assets/baari/queue-dashboard.png',
        '/assets/baari/checkin-card.png',
      ],
      url: 'getbaari.in',
      theme: 'dark',
    },
  },
  {
    slug: 'luca',
    index: '02',
    whyHere: 'Proof I can deliver a secure, bias-mitigated AI platform under real UK legal and ethical constraints.',
    path: '/work/luca',
    title: 'LUCA',
